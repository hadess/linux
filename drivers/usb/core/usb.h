...
extern int usb_revoke_for_device(int device_fd, kuid_t user);
extern int usb_revoke_for_user(kuid_t user);
extern int usb_revoke_for_userns(struct user_namespace *ns);
